            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    <form class="form-inline" id="search_from" name="search_from">
                        <label class="control-label" for="inputBookName">用户名：</label>
                        <input class="form-control" type="text" id="inputBookName" name="name"/>
            ...
            columns: [
                {
                    ...
                    formatter: function (value, row, index) {
                        var operateHtml = '<button type="button" class="btn btn-primary btn-sm addbtn" onclick="deleteUser('+row.id+')"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 删除</button>';
                        return operateHtml;
                    }
                }]
        });
