                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/regist">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input data-exist="name" id="userName" name="name" class="form-control" type="text" placeholder="请输入用户名。"
                                       >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="telephone" name="phone" class="form-control" placeholder="请输入您的电话号码。"
                                       >
                            </div>
                        </div>
